...
const projects = [
  ...
  },
  {
    name: "FCxLabs",
    description:
      "This is a customer registration system and its objective is to register users with email, password, cpf, telephone and birth data. It was a technical challenge",
    stack: [
      "React",
      "React Icons",
      "React Select",
